...
_LOCAL = ("app", "handlers_connect", "handlers_read", "handlers_woocommerce",
          ...
          "handlers_taxonomy", "handlers_links", "handlers_users", "handlers_menus", "handlers_post_lifecycle", "handlers_reviews", "handlers_site_settings", "handlers_redirects", "handlers_meta", "handlers_cache_cron", "handlers_database", "handlers_rest_api", "skeleton", "panels", "models", "storage", "wp_client", "wp_cli", "gutenberg")
for _mod in _LOCAL:
