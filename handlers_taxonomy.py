...
@chat.function(
    ...
    effects=["wp.post_category_create"], event="wordpress-hub.create_post_category")
...
@chat.function(
    ...
    action_type="write", data_model=PostTerm,
    effects=["wp.post_category_update"], event="wordpress-hub.update_post_category")
...
@chat.function(
    ...
    effects=["wp.post_category_delete"], event="wordpress-hub.delete_post_category")
...
@chat.function(
    ...
    action_type="write", data_model=PostTerm,
    effects=["wp.post_tag_create"], event="wordpress-hub.create_post_tag")
...
@chat.function(
    ...
    action_type="write", data_model=PostTerm,
    effects=["wp.post_tag_update"], event="wordpress-hub.update_post_tag")
...
@chat.function(
    ...
    action_type="destructive", data_model=TermDeleteResult,
    effects=["wp.post_tag_delete"], event="wordpress-hub.delete_post_tag")
